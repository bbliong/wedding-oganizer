...
<div style="display:none;" id="myDiv">
	<div class="wrap">
		  	...
		  	<div class="container-fluid">
			    ...
			    <div class="collapse navbar-collapse" id="myNavbar">
				    <div class="brand-centered">
				    	<a class="navbar-brand" href="#"><img src="/uploads/<?php echo e($view->logo_img); ?>" class="logo load"></a>
				    </div>	
		...
		<div id="mycarousel" class="carousel slide" data-ride="carousel">
		  	...
		  	<div class="carousel-inner" role="listbox">
			    ...
			    <div class="text">
					<p class="animasi pertama"><?php echo e($view->title_page); ?></p>
					<p class="animasi kedua"> <?php echo e($view->jumbotron); ?></p>
				</div>
			</div>
		</div>
		<div class="col-md-6 intro">
			<?php echo e($view->description); ?>
				...
				<div class="col-md-10 col-sm-12 back-paket">  
					<div id="owl-demo"  class="owl-carousel owl-theme owl-loaded owl-drag">
						<?php $__currentLoopData = $pakets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<div class="item">
						    		<a href="/paket/<?php echo e($paket->name); ?>" class="clickarea"></a>
						    		<img src="/uploads/<?php echo e($paket->featured_img); ?>" class="img-paket alignlefts" class="load">
						    		<div class="description">
							    		<p><?php echo e($paket->name); ?></p>
							    		<p><?php echo e($paket->price); ?></p>
						    		</div>
						    	</div>
	...
	<div class="col-md-12 footer">
		<div class="row">
			...
			<div class="col-sm-2">
				<ul>
					<li><a href="<?php echo e($view->fb_link); ?>" target="_blank">Facebook</a> </li>
					<li><a href="<?php echo e($view->twt_link); ?>" target="_blank">Twiiter</a></li>
					<li><a href="<?php echo e($view->ins_link); ?>" target="_blank">Instagram</a></li>
				</ul>
			</div>
			<div class="col-sm-2">
				<ul>
