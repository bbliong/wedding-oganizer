...
<title> Gallery <?php echo e($view->name); ?> </title>
...
<div class="container-gallery">
	<div class="header-gallery">
		<h3> Gallery <?php echo e($view->name); ?> </h3></br>
		<p> <?php echo e($view->description); ?> </p>
		<input type="hidden" id="id" value="<?php echo e($view->id_gallery); ?>"
		<div id="fine-uploader-manual-trigger"></div>
	</div>
	<div class="col-xs-12">
		<div class="tambah">
	...
	<?php $__currentLoopData = $view->singles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $single): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		<div class="img-container" style="cursor: pointer;"  data-fancybox="images" href="/uploads/gallery/<?php echo e($view->name); ?>/<?php echo e($single->name_photo); ?>">
			<a  class="delete-photo"  data-id="<?php echo e($single->id_photo); ?>" data-token="<?php echo e(csrf_token()); ?>">x</a>
			<img src="/uploads/gallery/<?php echo e($view->name); ?>/<?php echo e($single->name_photo); ?>" class="img-mini-preview">
			<div class="name-caption"><?php echo e($single->name_photo); ?> </div>
		</div>
